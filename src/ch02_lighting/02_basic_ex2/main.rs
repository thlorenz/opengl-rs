...
fn main() {
    ...
    let cube_shader = Shader::new(
        "src/ch02_lighting/02_basic_ex2/cube.vert",
        "src/ch02_lighting/02_basic_ex2/cube.frag",
    )
    .expect("Failed to create lighting shader");
    let lamp_shader = Shader::new(
        "src/ch02_lighting/02_basic_ex2/lamp.vert",
        "src/ch02_lighting/02_basic_ex2/lamp.frag",
    )
