...
fn main() {
    ...
    scene.camera = Camera {
        position: glm::vec3(-3.46, -1.21, 2.18),
        pitch: 24.22,
        yaw: -419.39,
        ..Camera::default()
    };
    ...
    let cube_shader = Shader::new(
        "src/ch02_lighting/05_1_light_casters_directional/cube.vert",
        "src/ch02_lighting/05_1_light_casters_directional/cube.frag",
    )
    ...
    unsafe {
        ...
        cube_shader.set_vec3(c_str!("light.direction"), &glm::vec3(-0.2, -1.0, -0.3));
